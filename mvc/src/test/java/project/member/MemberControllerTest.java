...
class MemberControllerTest {
    ...
    class Login {
        ...
        void success_redirectsToRoot() throws Exception {
            ...
            when(memberService.updateLastLogin(1L)).thenReturn(true);
    ...
    class IdCheck {
        ...
        void duplicated_returns1() throws Exception {
            when(memberService.countByLoginId("exist")).thenReturn(1);
        ...
        void available_returns0() throws Exception {
            when(memberService.countByLoginId("newUser")).thenReturn(0);
    ...
    void emailCheck_duplicated() throws Exception {
        when(memberService.countByEmail("dup@test.com")).thenReturn(1);
    ...
    void nicknmCheck_available() throws Exception {
        when(memberService.countByNickname("새닉네임")).thenReturn(0);
