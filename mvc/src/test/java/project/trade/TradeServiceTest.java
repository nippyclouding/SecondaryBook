...
class TradeServiceTest {
    ...
    // ========================================================================
    // updateToSoldManually - 수동 판매완료
    // ========================================================================
    @Nested
    @DisplayName("updateToSoldManually - 수동 판매완료")
    class UpdateToSoldManually {
        ...
        void 정상변경_true() {
            // given
            when(tradeMapper.updateToSoldManually(100L, 1L)).thenReturn(1);

            // when
            boolean result = tradeService.updateToSoldManually(100L, 1L);
        ...
        void 변경실패_false() {
            // given
            when(tradeMapper.updateToSoldManually(100L, 1L)).thenReturn(0);
