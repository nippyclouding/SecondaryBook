...
class AdminServiceTest {
    ...
    class Login {
        ...
        void successfulLogin() {
            ...
            when(adminMapper.findByLoginId("admin")).thenReturn(admin);
        ...
        void nonExistentId() {
            // given
            when(adminMapper.findByLoginId("unknown")).thenReturn(null);
    ...
    void getChartData() {
        // given
        when(adminMapper.findDailySignupStats()).thenReturn(Collections.emptyList());
        when(adminMapper.findDailyTradeStats()).thenReturn(Collections.emptyList());
        when(adminMapper.findCategoryStats()).thenReturn(Collections.emptyList());
    ...
    class RecentLists {
        ...
        void getRecentMembers() {
            ...
            when(adminMapper.findRecentMembers()).thenReturn(members);
        ...
        void getRecentTrades() {
            ...
            when(adminMapper.findRecentTrades()).thenReturn(trades);
        ...
        void getRecentBookClubs() {
            List<BookClubVO> clubs = Arrays.asList(new BookClubVO());
            when(adminMapper.findRecentBookClubs()).thenReturn(clubs);
    ...
    class LoginLogout {
        ...
        void recordAdminLogin() {
            ...
            verify(adminMapper).saveAdminLoginLog(1L, "192.168.0.1");
        }
        ...
        void recordMemberLogin() {
            ...
            verify(adminMapper).saveMemberLoginLog(10L, "10.0.0.1");
        }
        ...
        void getMemberLoginLogs() {
            List<LoginInfoVO> logs = Arrays.asList(new LoginInfoVO());
            when(adminMapper.findMemberLoginLogs()).thenReturn(logs);
        ...
        void getAdminLoginLogs() {
            List<LoginInfoVO> logs = Arrays.asList(new LoginInfoVO());
            when(adminMapper.findAdminLoginLogs()).thenReturn(logs);
    ...
    class BannerManagement {
        ...
        void getBanners() {
            ...
            when(adminMapper.findAllBanners()).thenReturn(banners);
        ...
        void saveBanner() {
            ...
            verify(adminMapper).saveBanner(banner);
        }
    ...
    class TempPageManagement {
        ...
        void saveTempPage() {
            ...
            doAnswer(invocation -> {
                ...
                vo.setPageSeq(100L);
                return null;
            }).when(adminMapper).saveTempPage(any(TempPageVO.class));
            ...
            verify(adminMapper).saveTempPage(any(TempPageVO.class));
        }
        ...
        void getTempPage() {
            ...
            vo.setPageSeq(100L);
            vo.setTitle("제목");
            when(adminMapper.findTempPage(100L)).thenReturn(vo);
    ...
    class NoticeManagement {
        ...
        void insertNotice() {
            ...
            verify(adminMapper).saveNotice(notice);
        }
        ...
        void selectNotice() {
            ...
            when(adminMapper.findNotice(1L)).thenReturn(notice);
        ...
        void increaseViewCount() {
            ...
            verify(adminMapper).incrementViewCount(1L);
        }
        ...
        void selectActiveNotices() {
            SearchVO searchVO = new SearchVO();
            List<NoticeVO> notices = Arrays.asList(new NoticeVO());
            when(adminMapper.findAllActiveNotices(searchVO)).thenReturn(notices);
