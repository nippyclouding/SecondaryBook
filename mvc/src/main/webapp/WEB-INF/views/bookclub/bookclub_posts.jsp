...
<div class="bc-post-form-wrapper">
    <div class="bc-post-form-shell">
        ...
        <div class="bc-post-header">
            <button type="button" class="bc-post-back-btn" onclick="location.href='${pageContext.request.contextPath}/bookclubs/${bookClubId}'">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"/>
                </svg>
            </button>
            <h1 class="bc-post-header-title">글 쓰기</h1>
        </div>
        ...
        <form id="postForm" method="post" action="${pageContext.request.contextPath}/bookclubs/${bookClubId}/posts" enctype="multipart/form-data">
            ...
            <div class="bc-post-form-body">
                ...
                <!-- 선택된 책 (숨김 상태로 시작) -->
                <div class="bc-selected-book" id="selectedBookCard">
                    <img src="" alt="책 표지" class="bc-selected-book-img" id="selectedBookImg">
                    <div class="bc-selected-book-info">
                        <p class="bc-selected-book-title" id="selectedBookTitle"></p>
                        <p class="bc-selected-book-author" id="selectedBookAuthor"></p>
                    </div>
                ...
                <div class="bc-attached-image-wrapper" id="attachedImageWrapper">
                    <div class="bc-attached-image">
                        <img src="" alt="첨부 이미지" id="attachedImagePreview">
            ...
            <div class="bc-post-footer">
                ...
                <!-- 등록 요청 버튼 -->
                <button type="submit" class="bc-post-submit-btn" id="postSubmitBtn" disabled>등록 요청</button>
            </div>
        </form>
    </div>
</div>
