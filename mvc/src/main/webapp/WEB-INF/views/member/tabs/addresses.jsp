    ...
    <div class="bg-white w-full max-w-md rounded-[2rem] shadow-2xl overflow-hidden relative z-10 transform transition-all scale-100">
        ...
        <div class="p-8">
            <form id="form-addr" onsubmit="AddressTab.submitAddress(event)" class="space-y-6">
                ...
                <div class="pt-2">
                    <button type="submit" id="btn-addr-submit"
                            class="w-full bg-primary-600 text-white py-4 rounded-2xl font-bold text-sm hover:bg-primary-700 shadow-lg hover:shadow-xl hover:-translate-y-0.5 transition-all disabled:opacity-50 disabled:cursor-not-allowed">
                        저장하기
                    </button>
                </div>
            </form>
    ...
    (function() {
        ...
        const actions = {
            ...
            submitAddress: async (e) => {
                ...
                const submitBtn = document.getElementById('btn-addr-submit');
