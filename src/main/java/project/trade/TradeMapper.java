...
public interface TradeMapper {
    ...
    List<TradeVO> selectWishTrades(@Param("member_seq") long member_seq); // 프로필 찜 목록 조회
    ...
    int successPurchase(@Param("trade_seq") Long trade_seq, @Param("member_buyer_seq") long member_buyer_seq,
